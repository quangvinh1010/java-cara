                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form action="EditCategoryServlet" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="name" type="text" value="${category.name}" class="form-control" id="email" aria-describedby="emailHelp" required>
                                        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="password" class="form-label">Thumbnail</label>
                                        <input name="thumbnail" type="text" value="${category.thumbnail}" class="form-control" id="email" aria-describedby="emailHelp" required>
                                    </div>
