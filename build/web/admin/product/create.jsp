                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form action="CreateProductServlet" method="post">
                                    <div class="mb-3">
                                        ...
                                        <input name="name" type="text" class="form-control" id="email" aria-describedby="emailHelp" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="thumbnail" type="text" class="form-control" id="email" aria-describedby="emailHelp" required>
                                        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Price</label>
                                        <input name="price" type="text" class="form-control" id="email" aria-describedby="emailHelp" required>
                                        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" class="form-label">quantity</label>
                                        <input name="quantity" type="text" class="form-control" id="email" aria-describedby="emailHelp" required>
                                        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="role" class="form-label">Category</label>
                                        <select name="categoryId" class="form-control" id="role" required>
